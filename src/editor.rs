...
impl Editor {
	...
	fn process_keypress(&mut self) -> Result<(), std::io::Error> {
		...
		// this will only get called when user pressed another key other than ctrl-q
		// and then resets the quit_times
	...
	#[allow(clippy::integer_division, clippy::integer_division)]
	fn draw_rows(&self) {
